...
import { krakenSpotHttpProviderKey, krakenSpotProviderKey, krakenSpotApiUrl } from './constants';
...
@Module({
  ...
  exports: [krakenSpotProviderKey],
})
export class KrakenSpotProviderModule {}
