...
import { kucoinSpotHttpProviderKey, kucoinSpotProviderKey, kucoinSpotApiUrl } from './constants';
...
@Module({
  ...
  exports: [kucoinSpotProviderKey],
})
export class KucoinSpotProviderModule {}
