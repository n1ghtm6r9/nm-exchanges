...
import { gateFuturesHttpProviderKey, gateFuturesProviderKey, gateFuturesApiUrl } from './constants';
...
@Module({
  providers: [
    ...
    {
      provide: gateFuturesProviderKey,
      useFactory: (
  ...
  exports: [gateFuturesProviderKey],
})
export class GateFuturesProviderModule {}
