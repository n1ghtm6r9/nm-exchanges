...
@Module({
  providers: [
    ...
    {
      provide: bingxFuturesProviderKey,
      useFactory: (
  ...
  exports: [bingxFuturesProviderKey],
})
export class BingxFuturesProviderModule {}
