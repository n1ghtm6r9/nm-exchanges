...
import { okxSpotHttpProviderKey, okxSpotProviderKey, okxSpotApiUrl } from './constants';
...
@Module({
  providers: [
    ...
    {
      provide: okxSpotHttpProviderKey,
  ...
  exports: [okxSpotProviderKey],
})
export class OkxSpotProviderModule {}
