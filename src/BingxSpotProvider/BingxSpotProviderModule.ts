...
import { bingxSpotHttpProviderKey, bingxSpotProviderKey, bingxSpotApiUrl } from './constants';
...
@Module({
  providers: [
    ...
    {
      provide: bingxSpotHttpProviderKey,
  ...
  exports: [bingxSpotProviderKey],
})
export class BingxSpotProviderModule {}
