...
import { mexcSpotHttpProviderKey, mexcSpotProviderKey, mexcSpotApiUrl } from './constants';
...
@Module({
  providers: [
    ...
    {
      provide: mexcSpotHttpProviderKey,
        ...
        httpClient.createHttpClient({
          ...
          onRequest: async config => {
            ...
            if (publicKey && [ExchangeSecurityTypeEnum.KEY, ExchangeSecurityTypeEnum.FULL].includes(<ExchangeSecurityTypeEnum>securityType)) {
              headers['X-MEXC-APIKEY'] = publicKey;
            }
  ...
  exports: [mexcSpotProviderKey],
})
export class MexcSpotProviderModule {}
