...
import { bybitSpotHttpProviderKey, bybitSpotProviderKey, bybitSpotApiUrl } from './constants';
...
@Module({
  providers: [
    ...
    {
      provide: bybitSpotHttpProviderKey,
  ...
  exports: [bybitSpotProviderKey],
})
export class BybitSpotProviderModule {}
