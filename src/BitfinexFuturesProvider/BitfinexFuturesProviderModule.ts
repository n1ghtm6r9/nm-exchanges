...
import { bitfinexFuturesHttpProviderKey, bitfinexFuturesProviderKey, bitfinexFuturesApiUrl } from './constants';
...
@Module({
  providers: [
    ...
    {
      provide: bitfinexFuturesProviderKey,
      useFactory: (
  ...
  exports: [bitfinexFuturesProviderKey],
})
export class BitfinexFuturesProviderModule {}
