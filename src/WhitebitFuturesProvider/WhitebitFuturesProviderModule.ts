...
import { whitebitFuturesHttpProviderKey, whitebitFuturesProviderKey, whitebitFuturesApiUrl } from './constants';
...
@Module({
  providers: [
    ...
    {
      provide: whitebitFuturesProviderKey,
      useFactory: (
  ...
  exports: [whitebitFuturesProviderKey],
})
export class WhitebitFuturesProviderModule {}
